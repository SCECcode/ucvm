...
${BIN_DIR}/ucvm_query -m ${MODEL} -p ucvm_utah -f ${CONF_DIR}/ucvm.conf < ${TEST_DIR}/test_latlons.txt  > $result 2>&1
${BIN_DIR}/ucvm_query -m ${MODEL} -p ucvm_utah -f ${CONF_DIR}/ucvm.conf < ${TEST_DIR}/test_latlons_wfcvm_gd.txt  >> $result 2>&1
...
Using Geo Depth coordinates as default mode.
 ...
 -118.0000    34.0000    500.000      0.000      0.000      wfcvm   3262.500   1744.652   2380.149       none      0.000      0.000      0.000      crust   3262.500   1744.652   2380.149
 -118.0000    34.0000   1000.000      0.000      0.000      wfcvm   3654.000   2100.000   2441.967       none      0.000      0.000      0.000      crust   3654.000   2100.000   2441.967
Using Geo Depth coordinates as default mode.
 -118.0000    34.0000      0.000      0.000      0.000      wfcvm   2871.000   1435.500   2318.331       none      0.000      0.000      0.000      crust   2871.000   1435.500   2318.331
...
echo "Running examples_programs_ucvm ucvm_query_wfcvm"
