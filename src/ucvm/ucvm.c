...
// toCHECK fprintf(stderr,"ucvm.c : SETTING PARAM..key(%s) %s : (%s) (%s)\n", key, mconf->label, flag[0], flag[1]);
...
/*** for plugin ***/
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MODEL, UCVM_MODEL_CRUSTAL,
                     UCVM_MODEL_SFCVM211, "", res, numinst++, *len)
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
#endif
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MODEL, UCVM_MODEL_CRUSTAL,
                     UCVM_MODEL_SFCVM, "", res, numinst++, *len)
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
#endif
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MODEL, UCVM_MODEL_CRUSTAL,
                     UCVM_MODEL_UWSFBCVM, "", res, numinst++, *len)
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
#endif
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MODEL, UCVM_MODEL_CRUSTAL,
                     UCVM_MODEL_SJFZ, "", res, numinst++, *len)
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
#endif
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MODEL, UCVM_MODEL_CRUSTAL,
                     UCVM_MODEL_CS248, "", res, numinst++, *len)
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
#endif
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MODEL, UCVM_MODEL_CRUSTAL,
                     UCVM_MODEL_SJQBN, "", res, numinst++, *len)
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
#endif
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MODEL, UCVM_MODEL_CRUSTAL,
                     UCVM_MODEL_MUSCALTDB, "", res, numinst++, *len)
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
#endif
  ...
  ***/
  ...
  if (ucvm_save_resource(UCVM_RESOURCE_MAP, UCVM_MODEL_CRUSTAL,
		     UCVM_MAP_UCVM_UTAH, "", res, numinst++, *len) 
      != UCVM_CODE_SUCCESS) {
    return(UCVM_CODE_ERROR);
  }
  if (ucvm_save_resource(UCVM_RESOURCE_MAP, UCVM_MODEL_CRUSTAL,
