...
if platform.system() == "Darwin" or platform.system() == "Linux" or dynamic_flag == True:
    ...
    print("</pre>")
    print("Then log out, and log in, move to tests directory, ")
    print("and run the tests. ")
    print("<pre>")
    print("cd " + ucvmpath.rstrip("/") + "/tests ")
    print("./run-tests ")
    print("</pre>")

    print("This will run the UCVM unit and acceptance tests. If all tests pass, UCVM is ")
    print("correctly installed and ready to use on your computer.")
    print("\nTo try out ucvm, once the tests pass, run an example query.")
    print("\n\nucvm_query -f "+ ucvmpath+"/conf/ucvm.conf -m cvms < " + ucvmpath+ "/tests/inputs/test_latlons.txt")
